<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ButterflySpread.aspx.cs" Inherits="TOC.ButterflySpread" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        <table style="width: 100%">
            <tr>
                <td>
                    <asp:Label runat="server" Text="Last Updated Time" BorderWidth="0"></asp:Label>
